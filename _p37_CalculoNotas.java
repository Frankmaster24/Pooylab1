...
public class _p37_CalculoNotas {
    public static void main(String[] args) {
        ...
        if ((promedio > 0) && (promedio <= 6)) {
            ...
            System.out.print(String.format("El promedio es: %.2f\nApenitas pasa carnal", promedio));
            
        }
        else if ((promedio > 7) && (promedio <=8)) {
            System.out.print(String.format("El promedio es: %.2f\nMuy bien,la puedes armar mejor mi todo tibio", promedio));
        }
        else if ((promedio > 8) && (promedio <=9)) {
            System.out.print(String.format("El promedio es: %.2f\nExcelente, Sigue asi mi amor", promedio));
        }
        else if ((promedio > 9) && (promedio <=10)) {
            System.out.print(String.format("El promedio es: %.2f\nPerfecto, Te la rifaste carnal", promedio));
        }
        obj.close();
    }
}